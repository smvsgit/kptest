...
export interface User { id:number; name:string; email:string; phone:string|null; department_id:number|null; department?:Department|null; organization_unit_id?:number|null; organization_unit?:OrganizationUnit|null; role:UserRole; permission_set_id?:number|null; permission_set?:PermissionSet|null; status?:'active'|'disabled'|'inactive'; status_reason?:string|null; locked_until?:string|null; last_login_at?:string|null; last_seen_at?:string|null; must_change_password?:boolean; preferred_language?:'en'|'gu'|null; two_factor_confirmed_at?:string|null; }
